 ...
 * @Notice 类型的检查会包含两个部分，一个是检查对象原始类型，一个是检查对象包装器类型(Object(1),Object(1n),Object(true))，如果有需求可以分别调用
...
/**
 * 检查 value 是否是原始Number数值型或者Number对象类型
 * @Notice 对象包装器和自变量
 * @param value
 */
...
/**
 * 检查 value 是否是原始字符串String或者String对象。
...
/**
 * 检查 value 是否是原始 Symbol 或者 Symbol 对象。
 * @param value
 */
...
/**
 * 检查 value 是否是原始 boolean 类型或者 boolean对象。
 * @param value
 */
...
/**
 * 检查 value 是否是原始 BigInt 类型或者 boolean对象。
 * @param value
 */
...
/**
 * 检查 value 是否是类数组。可以理解为可以被Array.from转换为数组的对象
...
/**
 * 检查 value 是否为 Object并且非null类型，
 * @Notice Object 中会包含function， arrays,regexp,new Number(0), 以及 new String('')
 * @param value
 */
...
/**
 * 检查 value 是否是 类对象
 * @Notice ObjectLike 中不会包含function，arrays,regexp,new Number(0), 以及 new String(''),但是可能会包含
 * @param value
 */
...
/**
 * 类型断言会调用所有的类型检查，返回一个类型数组,尽量不要使用断言，
