 ...
 * @param value
 */
export declare function isNil(value: null | undefined | any): boolean;
/**
 * 判断类型是否是null或者是undefined
 * @param value
 */
export declare function isNull(value: null | any): boolean;
/**
 * 判断类型是否是Object并且非空，function并非Object，这里需要注意
 * @param value
 */
export declare function isObject(value: null | any): boolean;
/**
